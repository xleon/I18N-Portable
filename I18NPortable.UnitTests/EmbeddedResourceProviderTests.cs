...
namespace I18NPortable.UnitTests
{
    ...
    public class EmbeddedResourceProviderTests
    {
        ...
        {
            var provider = new EmbeddedResourceProvider(GetType().Assembly, "OtherLocales").Init();
        ...
        {
            var provider = new EmbeddedResourceProvider(GetType().Assembly, "DuplicatedLocales");
        ...
        {
            var provider = new EmbeddedResourceProvider(GetType().Assembly).Init();
            var locales = provider.GetAvailableLocales().ToList();
        ...
        {
            var provider = new EmbeddedResourceProvider(GetType().Assembly, knownFileExtensions:new List<string>());
        ...
        public void AnyFileExtensions_CanBe_Loaded()
        {
            ...
            var provider = new EmbeddedResourceProvider(GetType().Assembly, "OtherLocales", knowExtensions).Init();
            var locales = provider.GetAvailableLocales().ToList();
